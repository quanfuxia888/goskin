...
func (c *city) WithContext(ctx context.Context) ICityDo { return c.cityDo.WithContext(ctx) }

func (c city) TableName() string { return c.cityDo.TableName() }

func (c city) Alias() string { return c.cityDo.Alias() }

func (c city) Columns(cols ...field.Expr) gen.Columns { return c.cityDo.Columns(cols...) }
...
type ICityDo interface {
	...
	Unscoped() ICityDo
	Create(values ...*gens.City) error
	CreateInBatches(values []*gens.City, batchSize int) error
	Save(values ...*gens.City) error
	First() (*gens.City, error)
	Take() (*gens.City, error)
	Last() (*gens.City, error)
	Find() ([]*gens.City, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gens.City, err error)
	FindInBatches(result *[]*gens.City, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*gens.City) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*gens.City, error)
	FirstOrCreate() (*gens.City, error)
	FindByPage(offset int, limit int) (result []*gens.City, count int64, err error)
...
func (c cityDo) Create(values ...*gens.City) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cityDo) CreateInBatches(values []*gens.City, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c cityDo) Save(values ...*gens.City) error {
	if len(values) == 0 {
		return nil
	}
...
func (c cityDo) First() (*gens.City, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gens.City), nil
	}
}

func (c cityDo) Take() (*gens.City, error) {
...
func (c cityDo) Last() (*gens.City, error) {
...
func (c cityDo) Find() ([]*gens.City, error) {
	result, err := c.DO.Find()
	return result.([]*gens.City), err
}

func (c cityDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gens.City, err error) {
	buf := make([]*gens.City, 0, batchSize)
...
func (c cityDo) FindInBatches(result *[]*gens.City, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c cityDo) FirstOrInit() (*gens.City, error) {
...
func (c cityDo) FirstOrCreate() (*gens.City, error) {
...
func (c cityDo) FindByPage(offset int, limit int) (result []*gens.City, count int64, err error) {
...
func (c cityDo) Delete(models ...*gens.City) (result gen.ResultInfo, err error) {
